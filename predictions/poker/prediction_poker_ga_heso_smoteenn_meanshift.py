...
def run_experiment_poker_9_vs_7():
    ...
    tuner.run_experiment(data,
                         'results/ga_heso_smoteenn_meanshift_poker_9_vs_7/GA_HESO_SMOTEENN_MEANSHIFT_poker_9_vs_7')
...
def run_experiment_poker_8_vs_6():
    ...
    tuner = GaOCBaggingTabnetEnsembleTunerParallel(tabnet_max_epochs=tabnet_max_epochs,
                                                   ...
                                                   use_cluster_centers=False)
    tuner.run_experiment(data,
                         'results/ga_heso_smoteenn_meanshift_poker_8_vs_6/GA_HESO_SMOTEENN_MEANSHIFT_poker_8_vs_6')
    print("--- total: %s seconds ---" % (time.time() - start_time))
...
def run_experiment_poker_8_9_vs_5():
    ...
    tuner = GaOCBaggingTabnetEnsembleTunerParallel(tabnet_max_epochs=tabnet_max_epochs,
                                                   ...
                                                   use_cluster_centers=False)
    tuner.run_experiment(data,
                         'results/ga_heso_smoteenn_meanshift_poker_8_9_vs_5/GA_HESO_SMOTEENN_MEANSHIFT_poker_8_9_vs_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))
...
def run_experiment_poker_8_9_vs_6():
    ...
    tuner = GaOCBaggingTabnetEnsembleTunerParallel(tabnet_max_epochs=tabnet_max_epochs,
                                                   ...
                                                   use_cluster_centers=False)
    tuner.run_experiment(data,
                         'results/ga_heso_smoteenn_meanshift_poker_8_9_vs_6/GA_HESO_SMOTEENN_MEANSHIFT_poker_8_9_vs_6')
    print("--- total: %s seconds ---" % (time.time() - start_time))
