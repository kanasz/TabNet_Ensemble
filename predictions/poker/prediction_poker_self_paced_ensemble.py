...
def run_experiment(poker_data, file_name):
    ...
    print(f"Starting simulation run: SelfPacedEnsemble with poker data...")
...
if __name__ == '__main__':
    ...
    run_experiment(poker_data=get_poker_8_vs_6(),
                   file_name="results/self_paced_ensemble_poker_8_vs_6")
    
    # poker_9_vs_7
    run_experiment(poker_data=get_poker_9_vs_7(),
                   file_name="results//self_paced_ensemble_poker_9_vs_7")
    
    # poker_8_9_vs_5
    run_experiment(poker_data=get_poker_8_9_vs_5(),
                   file_name="results//self_paced_ensemble_poker_8_9_vs_5")

    # poker_8_9_vs_6
    run_experiment(poker_data=get_poker_8_9_vs_6(),
                   file_name="results//self_paced_ensemble_poker_8_9_vs_6")
