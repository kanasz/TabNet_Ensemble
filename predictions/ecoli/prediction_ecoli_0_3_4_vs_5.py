...
from base_functions import get_synthetic_data, get_slovak_data, get_config_files, get_abalone_9_vs_18_data, \
    ...
    get_wine_quality_red_8_vs_6_data, get_ecoli_0_vs_1_data, get_ecoli_0_3_4_vs_5_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data,
                         'results/OC_TABNET_ENSEMBLE_CROSSENTROPYLOSS_ecoli_0_3_4_vs_5_CLUSTER_COUNT_{}_CLASSIFIER_COUNT_{}_SYNTH_COUNT_{}_2'
