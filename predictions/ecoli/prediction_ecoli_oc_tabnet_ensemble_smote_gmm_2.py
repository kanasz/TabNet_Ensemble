...
from base_functions import get_abalone_9_vs_18_data, \
    get_config_files, get_ecoli_0_vs_1_data, get_ecoli_0_2_3_4_vs_5_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/smote_gmm_2/OC_TABNET_ENSEMBLE_SMOTE_GMM_ecoli_0_2_3_4_vs_5')
