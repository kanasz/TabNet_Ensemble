...
from base_functions import get_abalone_9_vs_18_data, \
    ...
    get_ecoli_0_4_6_vs_5_data, get_ecoli_0_3_4_vs_5_data, get_ecoli_0_2_3_4_vs_5_data, get_dbscan_cluster_counts
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_dbscan_ecoli_0_4_6_vs_5/UNCLUSTERED_OC_TABNET_ENSEMBLE_SMOTE_DBSCAN_ecoli_0_4_6_vs_5')
