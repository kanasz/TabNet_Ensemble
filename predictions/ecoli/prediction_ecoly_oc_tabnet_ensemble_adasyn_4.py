...
from base_functions import get_config_files, get_wine_quality_white_9_vs_4_data, get_ecoli_0_2_3_4_vs_5_data, \
    get_ecoli_0_4_6_vs_5_data, get_ecoli_0_3_4_vs_5_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_ecoli_0_2_3_4_vs_5',loss_function=LossFunction.CROSSENTROPYLOSS)
