...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_ecoli_0_4_6_vs_5',loss_function=LossFunction.CROSSENTROPYLOSS)
