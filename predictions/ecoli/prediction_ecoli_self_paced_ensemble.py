...
from base_functions import get_ecoli_0_3_4_vs_5_data, get_ecoli_0_2_3_4_vs_5_data, get_ecoli_0_4_6_vs_5_data
from base_functions import get_ecoli_0_vs_1_data, set_seed
from constants import Classifier
from optimization.ga_tuner import GaTuner

set_seed(42)
np.set_printoptions(threshold=np.inf)
DIR_NAME = "results/self_paced_ensemble"
...
if __name__ == '__main__':
    ...
    run_experiment(ecoli_data=get_ecoli_0_vs_1_data(),
                   file_name=f"{DIR_NAME}/spe_ecoli_0_vs_1")

    # ecoli_0_2_3_4_vs_5
    run_experiment(ecoli_data=get_ecoli_0_2_3_4_vs_5_data(),
                   file_name=f"{DIR_NAME}/spe_ecoli_0_2_3_4_vs_5")

    # ecoli_0_3_4_vs_5
    run_experiment(ecoli_data=get_ecoli_0_3_4_vs_5_data(),
                   file_name=f"{DIR_NAME}/spe_ecoli_0_3_4_vs_5")

    # ecoli_0_4_6_vs_5
    run_experiment(ecoli_data=get_ecoli_0_4_6_vs_5_data(),
                   file_name=f"{DIR_NAME}/spe_ecoli_0_4_6_vs_5")
