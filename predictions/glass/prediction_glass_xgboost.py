...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/XGBoost_glass_0_1_6_vs_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))

    tuner = GaXGBoostTuner(num_generations, num_parents, population, True, False,numerical_cols, categorical_cols)
    tuner.run_experiment(data, 'results/XGBoost_SMOTE_glass_0_1_6_vs_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    categorical_cols = None
    tuner = GaXGBoostTuner(num_generations, num_parents, population, False, False, numerical_cols, categorical_cols)
    tuner.run_experiment(data, 'results/XGBoost_glass_2')
    print("--- total: %s seconds ---" % (time.time() - start_time))

    tuner = GaXGBoostTuner(num_generations, num_parents, population, True, False, numerical_cols, categorical_cols)
    tuner.run_experiment(data, 'results/XGBoost_SMOTE_glass_2')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    categorical_cols = None
    tuner = GaXGBoostTuner(num_generations, num_parents, population, False, False, numerical_cols, categorical_cols)
    tuner.run_experiment(data, 'results/XGBoost_glass_4')
    print("--- total: %s seconds ---" % (time.time() - start_time))

    tuner = GaXGBoostTuner(num_generations, num_parents, population, True, False, numerical_cols, categorical_cols)
    tuner.run_experiment(data, 'results/XGBoost_SMOTE_glass_4')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    categorical_cols = None
    tuner = GaXGBoostTuner(num_generations, num_parents, population, False, False, numerical_cols, categorical_cols)
    tuner.run_experiment(data, 'results/XGBoost_glass_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))

    tuner = GaXGBoostTuner(num_generations, num_parents, population, True, False, numerical_cols, categorical_cols)
    tuner.run_experiment(data, 'results/XGBoost_SMOTE_glass_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))