...
from base_functions import Classifier, set_seed
...
def run_experiment(glass_data, file_name):
    ...
    print(f"Starting simulation run for SVC combined with SMOTEENN...")
...
if __name__ == '__main__':
    ...
    run_experiment(glass_data=get_glass_2_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_glass_2")

    # glass_4
    run_experiment(glass_data=get_glass_4_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_glass_4")

    # glass_5
    run_experiment(glass_data=get_glass_5_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_glass_5")

    # glass_0_1_6_vs_5
    run_experiment(glass_data=get_glass_0_1_6_vs_5_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_glass_0_1_6_vs_5")
