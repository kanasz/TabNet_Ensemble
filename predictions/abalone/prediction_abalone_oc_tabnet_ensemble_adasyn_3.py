...
from base_functions import get_abalone_20_vs_8_9_10_data, get_config_files
...
if __name__ == '__main__':
    ...
    sampling_algorithm = ADASYN( sampling_strategy=sampling_strategy, random_state=42, n_neighbors=n_neighbors)
    ...
    tuner.run_experiment(data, 'results/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_abalone_20_vs_8_9_10',loss_function=actual_loss_function)
