...
if __name__ == '__main__':
    ...
    tuner = GaOCGenericTunerParallel(50, num_generations, num_parents, population,
                    clf_type=Classifier.FTTransformer, numerical_cols=numerical_cols,
                    categorical_cols=categorical_cols,
                                     sampling_algorithm=sampling_algorithm,
                                     clustering_algorithm=clustering_algorithm)

    tuner.run_experiment(data, 'results/OC_FTTransformer_abalone_20_vs_8_9_10',loss_function=None)
