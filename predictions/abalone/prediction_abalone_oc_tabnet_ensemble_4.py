...
from base_functions import get_synthetic_data, get_slovak_data, get_config_files, get_abalone_9_vs_18_data, \
    get_abalone_19_vs_10_11_12_13_data, get_abalone_3_vs_11_data, get_abalone_20_vs_8_9_10_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data,
                         'results/OC_TABNET_ENSEMBLE_CROSSENTROPYLOSS_abalone_20_vs_8_9_10_{}_CLUSTER_COUNT_{'
                         '}_CLASSIFIER_COUNT_{}_SYNTH_COUNT_{}_2'
