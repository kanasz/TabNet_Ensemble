...
from base_functions import get_abalone_3_vs_11_data, \
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_meanshift_abalone_3_vs_11/UNCLUSTERED_OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_abalone_3_vs_11')
