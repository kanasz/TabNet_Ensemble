...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/AdasynSVC_abalone_3_vs_11')
    ...
    tuner.run_experiment(data, 'results/AdasynSVC_abalone_9_vs_18')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    ...
                    clf_type=Classifier.SVC, numerical_cols=numerical_cols,
                    categorical_cols=categorical_cols)
    tuner.run_experiment(data, 'results/AdasynSVC_abalone_19_vs_10_11_12_13')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    '''
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    ...
                    clf_type=Classifier.SVC, numerical_cols=numerical_cols,
                    categorical_cols=categorical_cols)
    tuner.run_experiment(data, 'results/AdasynSVC_abalone_20_vs_8_9_10')
    print("--- total: %s seconds ---" % (time.time() - start_time))