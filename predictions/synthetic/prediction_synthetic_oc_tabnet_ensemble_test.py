...
if __name__ == '__main__':
    ...
    tuner.evaluate_experiment_from_pkl(data, actual_loss_function,
                                       'results_200_samples/OC_TABNET_ENSEMBLE_CROSSENTROPYLOSS_synthetic_{}_contamination_{}_features_{}_epochs_{}_population_{}'.format(contamination, features, samples, tabnet_max_epochs, population))
