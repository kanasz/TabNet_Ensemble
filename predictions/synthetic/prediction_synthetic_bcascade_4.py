...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/BCascade_synthetic_01')
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    ...
                    clf_type=Classifier.BalancedCascade, numerical_cols=numerical_cols,
                    categorical_cols=None)
    tuner.run_experiment(data, 'results/BCascade_synthetic_02')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    ...
                    clf_type=Classifier.BalancedCascade, numerical_cols=numerical_cols,
                    categorical_cols=None)
    tuner.run_experiment(data, 'results/BCascade_synthetic_03')
    print("--- total: %s seconds ---" % (time.time() - start_time))