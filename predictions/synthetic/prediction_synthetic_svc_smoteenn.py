...
if __name__ == '__main__':
    ...
    run_experiment(data_prefix='01', data_contamination='0.3', data_features=50,
                   file_name="results/svc_smoteenn_01_synthetic_0.3_contamination_50_features")
    ...
    run_experiment(data_prefix='02', data_contamination='0.1', data_features=100,
                   file_name="results/svc_smoteenn_02_synthetic_0.1_contamination_100_features_200_samples",
                   data_samples=200)
    ...
    run_experiment(data_prefix='03', data_contamination='0.02', data_features=200,
                   file_name="results/svc_smoteenn_03_synthetic_0.02_contamination_200_features_200_samples")
