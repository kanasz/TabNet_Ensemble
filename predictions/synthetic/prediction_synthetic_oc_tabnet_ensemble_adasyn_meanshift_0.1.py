...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_adasyn_meanshift_synthetic_0.1/UNCLUSTERED_OC_TABNET_ENSEMBLE_ADASYN_MEANSHIFT_synthetic_{}'.format(contamination))
