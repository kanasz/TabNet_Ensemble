...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_meanshift_synthetic_0.05/UNCLUSTERED_OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_synthetic_{}'.format(contamination))
