...
from base_functions import get_config_files, get_yeast_3_data, get_yeast_4_data, get_yeast_5_data, get_yeast_6_data
...
if __name__ == '__main__':
    __run_experiment(get_yeast_3_data(), 'yeast_3',
                     'results/no_clustering_smote_yeast_3/NO_CLUSTERING_OC_TABNET_ENSEMBLE_SMOTE_yeast_3')

    __run_experiment(get_yeast_4_data(), 'yeast_4',
                     'results/no_clustering_smote_yeast_4/NO_CLUSTERING_OC_TABNET_ENSEMBLE_SMOTE_yeast_4')

    __run_experiment(get_yeast_5_data(), 'yeast_5',
                     'results/no_clustering_smote_yeast_5/NO_CLUSTERING_OC_TABNET_ENSEMBLE_SMOTE_yeast_5')

    __run_experiment(get_yeast_6_data(), 'yeast_6',
                     'results/no_clustering_smote_yeast_6/NO_CLUSTERING_OC_TABNET_ENSEMBLE_SMOTE_yeast_6')