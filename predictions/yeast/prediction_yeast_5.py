...
from base_functions import get_config_files, get_yeast_3_data, get_yeast_4_data, get_yeast_5_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data,
                         'results/OC_TABNET_ENSEMBLE_CROSSENTROPYLOSS_yeast_5_CLUSTER_COUNT_{}_CLASSIFIER_COUNT_{}_SYNTH_COUNT_{}_2'
