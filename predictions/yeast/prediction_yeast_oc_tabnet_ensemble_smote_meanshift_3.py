...
from base_functions import get_abalone_9_vs_18_data, \
    ...
    get_yeast_3_data, get_yeast_4_data, get_yeast_5_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/smote_meanshift_yeast_5/OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_yeast_5')
