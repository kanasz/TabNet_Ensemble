...
from base_functions import get_abalone_9_vs_18_data, \
    ...
    get_yeast_3_data, get_yeast_6_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_meanshift_yeast_3/UNCLUSTERED_OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_yeast_3')
