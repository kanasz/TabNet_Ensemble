...
if __name__ == '__main__':
    # yeast 3
    run_experiment(yeast_data=get_yeast_3_data(), file_name="results/xgboost_smoteenn_yeast_3")
    
    # yeast 4
    run_experiment(yeast_data=get_yeast_4_data(), file_name="results/xgboost_smoteenn_yeast_4")
    
    # yeast 5
    run_experiment(yeast_data=get_yeast_5_data(), file_name="results/xgboost_smoteenn_yeast_5")

    # yeast 6
    run_experiment(yeast_data=get_yeast_6_data(), file_name="results/xgboost_smoteenn_yeast_6")
