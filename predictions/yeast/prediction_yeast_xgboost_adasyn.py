...
if __name__ == '__main__':
    ...
    run_experiment(yeast_data=get_yeast_3_data(),
                   file_name=f"{DIR_NAME}/xgboost_adasyn_yeast_3")

    # yeast_4
    run_experiment(yeast_data=get_yeast_4_data(),
                   file_name=f"{DIR_NAME}/xgboost_adasyn_yeast_4")

    # yeast_5
    run_experiment(yeast_data=get_yeast_5_data(),
                   file_name=f"{DIR_NAME}/xgboost_adasyn_yeast_5")

    # yeast_6
    run_experiment(yeast_data=get_yeast_6_data(),
                   file_name=f"{DIR_NAME}/xgboost_adasyn_yeast_6")
