...
process.cpu_affinity([5,6,7,8,9])
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_meanshift_synthetic_{}_{}/UNCLUSTERED_OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_ss_{}_imb_{}_feat_{}_samples_{}'
