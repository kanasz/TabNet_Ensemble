...
from base_functions import get_abalone_9_vs_18_data, \
    ...
    get_abalone_20_vs_8_9_10_data, get_wine_quality_red_8_vs_6_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results_sensitivity/{}/OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_{}_red_8_vs_6'.format(cfl_count, cfl_count), max_classifier_count=cfl_count)
