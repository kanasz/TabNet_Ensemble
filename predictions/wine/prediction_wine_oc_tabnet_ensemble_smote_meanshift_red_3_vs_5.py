...
from base_functions import get_abalone_9_vs_18_data, \
    get_config_files, get_meanshift_cluster_counts, get_wine_quality_white_9_vs_4_data, \
    get_wine_quality_white_3_vs_7_data, get_wine_quality_red_8_vs_6_data, get_wine_quality_red_3_vs_5_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_meanshift_red_3_vs_5/UNCLUSTERED_OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_red_3_vs_5')
