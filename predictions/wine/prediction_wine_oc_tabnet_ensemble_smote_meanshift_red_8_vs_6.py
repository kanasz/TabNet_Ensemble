...
from base_functions import get_abalone_9_vs_18_data, \
    ...
    get_wine_quality_white_3_vs_7_data, get_wine_quality_red_8_vs_6_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_meanshift_red_8_vs_6/UNCLUSTERED_OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_red_8_vs_6')
