...
from base_functions import get_abalone_9_vs_18_data, \
    get_config_files, get_meanshift_cluster_counts, get_wine_quality_white_9_vs_4_data, get_wine_quality_white_3_vs_7_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/adasyn_meanshift_white_3_vs_7/OC_TABNET_ENSEMBLE_ADASYN_MEANSHIFT_white_3_vs_7')
