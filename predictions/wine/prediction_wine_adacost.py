...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/AdaCost_white_3_vs_7')
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    ...
                    use_adasyn=False,
                    clf_type=Classifier.AdaCost, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/AdaCost_white_9_vs_4')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    ...
                    use_adasyn=False,
                    clf_type=Classifier.AdaCost, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/AdaCost_red_8_vs_6')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    '''
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    ...
                    use_adasyn=False,
                    clf_type=Classifier.AdaCost, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/AdaCost_red_3_vs_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))