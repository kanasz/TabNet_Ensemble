...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/SVC_white_3_vs_7')
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=True,
                    clf_type=Classifier.SVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_SMOTE_white_3_vs_7')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner.run_experiment(data, 'results/SVC_WEIGHTED_white_3_vs_7')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=False,
                    clf_type=Classifier.SVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_white_9_vs_4')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=True,
                    clf_type=Classifier.SVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_SMOTE_white_9_vs_4')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=False,
                    clf_type=Classifier.WeightedSVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_WEIGHTED_white_9_vs_4')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=False,
                    clf_type=Classifier.SVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_red_8_vs_6')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=True,
                    clf_type=Classifier.SVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_SMOTE_red_8_vs_6')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=False,
                    clf_type=Classifier.WeightedSVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_WEIGHTED_red_8_vs_6')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=False,
                    clf_type=Classifier.SVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_red_3_vs_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=True,
                    clf_type=Classifier.SVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_SMOTE_red_3_vs_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))
    ...
    tuner = GaTuner(num_generations, num_parents, population,
                    use_smote=False,
                    clf_type=Classifier.WeightedSVC, numerical_cols=numerical_columns)
    tuner.run_experiment(data, 'results/SVC_WEIGHTED_red_3_vs_5')
    print("--- total: %s seconds ---" % (time.time() - start_time))