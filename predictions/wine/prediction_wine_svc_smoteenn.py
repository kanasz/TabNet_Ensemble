...
if __name__ == '__main__':
    ...
    run_experiment(wine_data=get_wine_quality_white_3_vs_7_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_wine_white_3_vs_7")

    # wine_white_9_vs_4
    run_experiment(wine_data=get_wine_quality_white_9_vs_4_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_wine_white_9_vs_4")

    # wine_red_8_vs_6
    run_experiment(wine_data=get_wine_quality_red_8_vs_6_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_wine_red_8_vs_6")

    # wine_red_3_vs_5
    run_experiment(wine_data=get_wine_quality_red_3_vs_5_data(),
                   file_name=f"{DIR_NAME}/svc_smoteenn_wine_red_3_vs_5")
