...
from base_functions import get_abalone_9_vs_18_data, \
    get_config_files, get_wine_quality_red_3_vs_5_data, get_wine_quality_red_8_vs_6_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_red_3_vs_5',loss_function=LossFunction.CROSSENTROPYLOSS)
