...
from base_functions import get_config_files, get_wine_quality_white_3_vs_7_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_white_3_vs_7',loss_function=LossFunction.CROSSENTROPYLOSS)
