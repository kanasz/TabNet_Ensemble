...
from base_functions import get_config_files, get_ecoli_0_vs_1_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/ecoli_0_vs_1/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_ecoli_0_vs_1_SYNTHETIC_COUNT_{}_CLUSTER_COUNT_{}'.format(synthetic_count, cluster_count))
