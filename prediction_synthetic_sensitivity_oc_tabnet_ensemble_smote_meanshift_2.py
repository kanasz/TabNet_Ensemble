...
if __name__ == '__main__':
    ...
    data = get_synthetic_data('02', contamination, features)
    ...
    tuner.run_experiment(data, 'results/unclustered_smote_meanshift_synthetic_02/OC_TABNET_ENSEMBLE_ADASYN_MEANSHIFT_synthetic_02')
