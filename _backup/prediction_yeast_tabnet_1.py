...
from base_functions import get_synthetic_data, get_slovak_data, get_abalone_9_vs_18_data, \
    ...
    get_wine_quality_white_9_vs_4_data, get_ecoli_0_vs_1_data, get_glass_2_data, get_yeast_3_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'tabnet_smote_yeast/01/TabNetSmote_yeast_3')
