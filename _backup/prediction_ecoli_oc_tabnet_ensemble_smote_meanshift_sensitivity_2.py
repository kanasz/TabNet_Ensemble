...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'ecoli_sensitivity/{}/OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_{}_ecoli_0_vs_1'.format(cfl_count, cfl_count), max_classifier_count=cfl_count)
