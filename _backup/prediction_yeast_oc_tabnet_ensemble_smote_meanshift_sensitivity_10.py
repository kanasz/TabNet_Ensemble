...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results_sensitivity_yeast/{}/OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_{}_yeast_3'.format(cfl_count, cfl_count), max_classifier_count=cfl_count)
