...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'abalone_sensitivity/{}/OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_{}_abalone_20_vs_8_9_10'.format(cfl_count, cfl_count), max_classifier_count=cfl_count)
