...
if __name__ == '__main__':
    ...
    tuner = GaOCBaggingTabnetEnsembleTunerParallel(tabnet_max_epochs, num_generations, num_parents, population,
                                           ...
                                           sampling_algorithm=sampling_algorithm, numerical_cols=numerical_cols, save_partial_output=True)
    tuner.run_experiment(data,
                         'synthetic_adasyn/01/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_synthetic_{}_CLUSTER_COUNT_{}_CLASSIFIER_COUNT_{}_SYNTH_COUNT_{}'
