...
if __name__ == '__main__':
    ...
    data = get_synthetic_data('03', contamination, features)
    ...
    tuner.run_experiment(data, 'synthetic/03/OC_TABNET_ENSEMBLE_SMOTE_MEANSHIFT_synthetic_{}'.format(contamination))
