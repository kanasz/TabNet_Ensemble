...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/yeast_3/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_yeast_3_SYNTHETIC_COUNT_{}_CLUSTER_COUNT_{}'.format(synthetic_count, cluster_count))
