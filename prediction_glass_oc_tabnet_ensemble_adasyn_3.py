...
from base_functions import get_config_files, get_glass_5_data
...
if __name__ == '__main__':
    ...
    tuner.run_experiment(data, 'results/OC_TABNET_ENSEMBLE_ADASYN_KMEANS_glass_5',loss_function=LossFunction.CROSSENTROPYLOSS)
